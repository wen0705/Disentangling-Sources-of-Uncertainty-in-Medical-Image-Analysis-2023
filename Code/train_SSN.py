...
# Training
# ssn_model.train_model(model, train_loader, test_loader, opt, epochs=800)#
# Test
#testing
# Experiment 1
# PATH = '/mnt/qb/work/berens/bep958/Probabilistic-Unet-offical/Code/model/checkpoints/ssn_model.pt'


# Experiment 2
PATH = '/mnt/qb/work/berens/bep958/Probabilistic-Unet-offical/Code/model/checkpoints/ssn_sOOD_model.pt'
ssn_model.testing(model, test_loader, opt,PATH,'C')

# Experiment 3
# PATH = '/mnt/qb/work/berens/bep958/Probabilistic-Unet-offical/Code/model/checkpoints/ssn_pOOD_model.pt'
# ssn_model.testing(model, test_loader, opt,PATH,'D')

# Experiment 4

# PATH = '/mnt/qb/work/berens/bep958/Probabilistic-Unet-offical/Code/model/checkpoints/ssn_gOOD_model.pt'
# ssn_model.testing(model, test_loader, opt,PATH,'A')
